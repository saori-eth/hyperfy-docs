  ...
  return (
    <>
      ...
      className="prose prose-sm sm:prose-base lg:prose-lg prose-invert max-w-none
        ...
        prose-p:leading-6 sm:prose-p:leading-7 prose-p:mb-3 sm:prose-p:mb-4 prose-p:text-gray-300
        prose-a:text-blue-400 prose-a:no-underline hover:prose-a:underline hover:prose-a:text-blue-300
        prose-code:bg-gray-800 prose-code:px-1 prose-code:py-0.5 prose-code:rounded prose-code:text-xs sm:prose-code:text-sm prose-code:text-gray-200
        prose-pre:bg-gray-800 prose-pre:p-3 sm:prose-pre:p-4 prose-pre:rounded-lg prose-pre:overflow-x-auto prose-pre:text-xs sm:prose-pre:text-sm
        prose-ul:list-disc prose-ul:pl-4 sm:prose-ul:pl-6 prose-ul:text-gray-300
        prose-ol:list-decimal prose-ol:pl-4 sm:prose-ol:pl-6 prose-ol:text-gray-300
        prose-li:mb-1 sm:prose-li:mb-2
        prose-blockquote:border-l-4 prose-blockquote:border-gray-600 prose-blockquote:pl-3 sm:prose-blockquote:pl-4 prose-blockquote:italic prose-blockquote:text-gray-400
